...
Pick a function by the **external data available** and the **internal
study design**:
...
Each function has **low-dimensional**, **ridge**, and **elastic-net /
LASSO** variants, plus cross-validation, stability selection, bagging,
and Bayesian- optimization helpers for tuning the integration weight η.
...
- **Vignettes**: `SurvBregDiv`, `coxkl`, `coxkl_ties`, `ncc`,
  `CV_Criteria`
